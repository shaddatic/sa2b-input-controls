...
typedef struct
{
    ...
    */
    int32_t  (__cdecl* GetInt)(    const c8* uSect, const c8* uKey, int32_t   def );
    bool     (__cdecl* GetBool)(   const c8* uSect, const c8* uKey, bool      def );
    f64      (__cdecl* GetFloat)(  const c8* uSect, const c8* uKey, f64       def );
    const c8*(__cdecl* GetString)( const c8* uSect, const c8* uKey, const c8* def );
}
ICAPI_CONFIG;
